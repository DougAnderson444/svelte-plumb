...
const components = [
  ...
  () => __vitePreload(() => import("./pages/index.svelte-6b6ec6ce.js"), true ? ["_app/immutable/pages/index.svelte-6b6ec6ce.js","_app/immutable/assets/index-6466544d.css","_app/immutable/chunks/index-d0ae24fe.js"] : void 0)
];
const dictionary = {
  "": [[0, 2], [1]]
};
...
function create_updated_store() {
  ...
  async function check() {
    ...
    if (res.ok) {
      ...
      const updated = version !== "1660840419781";
      if (updated) {
        set(true);
        clearTimeout(timeout);
      }
...
//# sourceMappingURL=start-99f680c8.js.map
